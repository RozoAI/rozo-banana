...
export async function GET() {
  ...
  return Response.json({
    ...
    frame: withValidProperties({
      ...
      screenshotUrls: [],
      iconUrl: "https://b.rozo.ai/apple-icon.png",
      splashImageUrl: "https://b.rozo.ai/apple-icon.png",
      splashBackgroundColor: "#ffffff",
      homeUrl: URL,
      webhookUrl: `${URL}api/webhook`,
      primaryCategory: "art-creativity",
      tags: ["rozo", "banana", "AI", "image", "generation"],
      heroImageUrl: "https://b.rozo.ai/apple-icon.png",
      tagline: "Create AI images. Earn points!",
      ogTitle: "Rozo Banana",
      ogDescription: "Create AI images. Earn points!",
      ogImageUrl: "https://b.rozo.ai/apple-icon.png",
    ...
    miniapp: {
      ...
      iconUrl: "https://b.rozo.ai/apple-icon.png",
      homeUrl: URL,
      imageUrl: "https://b.rozo.ai/apple-icon.png",
      buttonTitle: "Buy and Earn Rewards",
      splashImageUrl: "https://b.rozo.ai/apple-icon.png",
      splashBackgroundColor: "#ffffff",
      // webhookUrl: `${URL}api/webhook`,
